			...
			<c:if test="${!empty(order)}">
				<div >
					<table class="table table-bordered table-hover">
						<tr>
							<th col style="width: 10px">商品名称</th>
							<th col style="width: 50px">商品图片</th>
							<th col style="width: 50px">原价</th>
							<th col style="width: 50px">折后价</th>
							<th col style="width: 50px">数量</th>
						</tr>
						<c:forEach var="i" items="${order.productItems}">
							<tr> 
								<td>${i.name}</td>
								<td><img id="img1" src="Productimg/upload/${i.listimg}" width="20" height="20" style="max-width: none;" onmouseenter="imgBig(this)" cla onmouseleave="imgSmall(this)"/></td>
								<td>${i.price}</td>
