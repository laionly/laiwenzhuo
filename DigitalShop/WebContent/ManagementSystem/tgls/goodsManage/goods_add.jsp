...
<script type="text/javascript">
   function cPost ()
   {
	...
	<body>
		<div class="cBody">
			<form id="addForm" class="layui-form" action="../../../addProduct" method="post" enctype="multipart/form-data" onsubmit="cPost();">
				<div class="layui-form-item">
					<label class="layui-form-label">商品名称</label>
					<div class="layui-input-inline shortInput">
						<input type="text" name="name" required lay-verify="required|identity" autocomplete="off" class="layui-input">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input type="text" name="description" required lay-verify="required|PriceCheck" autocomplete="off" class="layui-input">
					</div>
					<i class="iconfont icon-huaban bt"></i>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input type="text" name="discountprice" autocomplete="off" class="layui-input">
					</div>
					<i class="iconfont icon-huaban bt"></i>
				</div>
				...
				<div class="layui-form-item">
					<div class="layui-input-block">
						<input class="layui-btn" type="submit" value="立即提交" onclick="return f();">
