...
<body>
				...
				<nav id="nav" class="navbar">
					...
					<div class="site-header -icon">
						...
						<div class="site-header__cart item-dropdown">
							<a href="cart.html" class="site-header__cart-toggle"> <span
								class="cartcount">3</span> <i class="fa fa-shopping-basket"
							...
							<div class="widget_shopping_cart_content  content-dropdown">
								<div class="cart_list ">
									<div class="media widget-product">
										<div class="media-left">
											<a href="product_single.html" class="image pull-left"> <img
												src="assets/images/product/product_1.jpg" alt="">
											</a>
										</div>
										<div class="cart-main-content media-body">
											<h3 class="name">
												<a href="product_single.html"> Gym Training Gloves </a>
											</h3>
											<p class="cart-item">
									...
									<div class="media widget-product">
										<div class="media-left">
											<a href="product_single.html" class="image pull-left"> <img
												src="assets/images/product/product_3.jpg" alt="">
											</a>
										</div>
										<div class="cart-main-content media-body">
											<h3 class="name">
									...
									<div class="media widget-product">
										...
										<div class="cart-main-content media-body">
											...
											<p class="cart-item">
												<span class="quantity">2 × <span
													class="price-amount amount"><span
														class="price-currencySymbol">$</span>200.00</span></span>
											</p>
											<a href="#" class="remove" title="Remove this item">×</a>
										</div>
									</div>
								...
								<p class="total">
									<strong>Subtotal:</strong> <span class="price-amount amount">
										<span class="price-currencySymbol">$</span>700.00
									</span>
								</p>
	...
	<div class="breadcrumb">
		...
		<div class="account-form" style="width:400px; margin-left:189px;">
		<form action="UploadProfile_Picture" method="post" enctype="multipart/form-data">
		<p style="display:inline-block;float:left;margin-top: 75px;">用户头像：</p><input type="image" name="head_portrait" src="/img/${user.head_portrait}" style="width:150px;height:150px;display:inline-block; " /><br>
		<input type="file" id="file" name="file">
		<input type="submit" value="上传头像">
		</form>
			<form action="UpdateUser" method="post">
			<input type="hidden" name="head_portrait" src="/img/${user.head_portrait}" value="${user.head_portrait}" style="width:150px;height:150px;display:inline-block; " />
			         <input type="hidden" type="text" name="userid" value="${user.userid}" placeholder="id">
				用户名:<input type="text" name="username" value="${user.username}" placeholder="用户名"> 
				密码:<input type="text" name="password" value="${user.password}" placeholder="密码"> 
				Email:<input type="text" name="email" value="${user.email}" placeholder="Email"> 
				地址:<input type="text" name="address" value="${user.address}" placeholder="地址"> 
				电话:<input type="text" name="phone" value="${user.phone}" placeholder="电话">
				<div style="color: red">
