				...
				<div class="top-bar">
			        <div class="top-bar__left pull">
			        	...
			        	<c:if test="${empty(sessionScope.user.username) }">
				            <a class="top-bar__item" href="account.jsp">
                                ...
                                <div class="account-form-container register-form">
                                    <div class="account-form">
                                        <form action="AddUserServlet" method="post"  >
                                        	<input type="text"  name="username" id="username" onblur="checkUsername(this.value)" placeholder="用户名">
                                            <input type="password"  name="password" id="newpassword" placeholder="密码">
                                            <input type="password"  name="password1"  id="confirmNewPassword" onblur="validate()" placeholder="确认密码">
