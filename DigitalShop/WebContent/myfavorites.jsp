...
<script type="text/javascript" src="ManagementSystem/framework/jquery-1.11.3.min.js"></script>
<script type="text/javascript" src="ManagementSystem/framework/bootstrap.min.js"></script>
<link rel="styleone" type="text/css" href="ManagementSystem/css/bootstrap.css">
...
<c:if test="${empty(user.collects)}"><p  style="display: block; text-align: center;">收藏为空</p></c:if>
		<div class="account-form" style="width:100%; margin-left:189px;">
		<c:if test="${!empty(user.collects)}">
		<div class="cBody">
			<table class="table table-bordered table-hover">
    <tr>
        <th col style="width: 20%">收藏项ID</th>
        <th col style="width: 20%">收藏商品</th>
        <th col style="width: 20%">商品图片 </th>
         <th col style="width: 20%">价格 </th>
    ...
    <c:forEach var="i" items="${user.collects }">
					<tr>
						...
						<td><img id="img1" src="Productimg/upload/${i.product.listimg}" width="20" height="20" style="max-width: none;" onmouseenter="imgBig(this)" onmouseleave="imgSmall(this)"/></td>
						<td>${i.product.price }</td>
						<td>
							<a href="RemoveCollect?cid=${i.cid}"><button class="layui-btn layui-btn-xs" >移除收藏</button></a>
						</td>
					</tr>
				</c:forEach>
</table>
