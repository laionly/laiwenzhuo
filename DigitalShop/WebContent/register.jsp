                                ...
                                <div class="account-form-container register-form">
                                    <div class="account-form">
                                        <form action="AddUser" method="post"  >
                                        	<input type="text"  name="username" value="<%=request.getAttribute("username")==null ? "":request.getAttribute("username")%>" id="username" onblur="checkUsername(this.value)" placeholder="用户名">
                                            <input type="password"  name="password" value="<%=request.getAttribute("password")==null ? "":request.getAttribute("password")%>" id="newpassword" placeholder="密码">
                                            <input type="password"  name="password1" value="<%=request.getAttribute("password")==null ? "":request.getAttribute("password")%>" id="confirmNewPassword" onblur="validate()" placeholder="确认密码">
                                            <input type="text"  name="email" value="<%=request.getAttribute("email")==null ? "":request.getAttribute("email")%>" id="email" placeholder="Email">
                                            <input type="text"  name="address" value="<%=request.getAttribute("address")==null ? "":request.getAttribute("address")%>" id="address" placeholder="地址">
                                            <input type="text"  name="phone" value="<%=request.getAttribute("phone")==null ? "":request.getAttribute("phone")%>" id="phone" placeholder="电话">
                                            <div style="color: red">
