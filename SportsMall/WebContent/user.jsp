...
姓名:<span>${u.username}</span><br>
密码:<span>${u.password}</span><br>
电话:<span>${u.phone}</span><br>
邮箱:<span>${u.email}</span><br>
地址:<span>${u.address}</span>
		<span><a href="UserDeleteServlet?id=${u.id }">删除</a></span> 
		<span><a href="UserSelectServlet?id=${u.id }">修改</a></span>
	</c:forEach>
</div>
	<!-- 底部导航 -->
	<div class="footer">
