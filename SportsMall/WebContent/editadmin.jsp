...
<script src="js/checklogin-editadmin.js"></script>
...
<div class="header">
    ...
    <div class="information">
        <form action="AdmineUpdateServlet" method="get">
        <input type="hidden" name="id" value="${Myadmin.id}">
        姓名:<input type="text" name="loginname" value="${Myadmin.loginname}"  /><br>
        密码:<input type="text" name="password" value="${Myadmin.password}"  /><br>
        电话:<input type="text" name="phone" value="${Myadmin.phone}"  /><br>
        邮箱:<input type="text" name="email" value="${Myadmin.email}"  /><br>
        地址:<input type="text" name="address" value="${Myadmin.address}"  /> 
        <input type="hidden" name="code" value="${Myadmin.code}"/>
