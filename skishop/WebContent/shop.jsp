					 ...
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
								...
								<li><a href="addproduct.jsp">增加商品</a></li>
								<li><a href="UserAllList2Servlet">查看用户列表</a></li>									
								<div class="clear"></div>
							</ul>
					 ...
					 <li><a class="active-icon c1" href="#"> </a>
						<ul class="sub-icon1 list">
						  ...
						  <div class="login_buttons">
							 <div class="check_button"><a href="ShowCartServlet">去购物车结算</a></div>
							 <li><a href="UserListServlet">修改个人信息</a></li>
		...
		<div class="container">
			<div class="row shop_box-top">
				...
				<div class="col-md-3 shop_box"><a href="single.html">
					<img src="images/${p.listimg}" class="img-responsive" alt=""/>
					<span class="new-box">
					...
					<div class="shop_desc">
						...
						<span class="reducedfrom"><a href="ProductEditServlet?id=${p.id}">修改</a></span>
						<span class="reducedfrom"><a href="ProductDeleteServlet?id=${p.id}">删除</a></span>
						<ul class="buttons">
							<li class="cart"><a href="cart?id=${p.id}">加入购物车</a></li>
							<li class="shop_btn"><a href="ShowCartServlet">去购物车结算</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</a></div>
