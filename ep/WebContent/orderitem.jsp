    ...
    <main class="site-main shopping-cart">
		...
		<%-- <c:if test="${!empty(orderlist.list)}"> --%>
                            <table class="table">
                                <thead>
                                <tr>
                                    <th class="tb-image">商品名</th>
                                    <th class="tb-product">原价</th>
                                    <th class="tb-product">折后价</th>
                                    <th class="tb-price">数量</th>
                                    <th class="tb-qty">商品图片</th>
                                ...
                                <tbody>
                              <c:forEach var="i" items="${orderitems.list}">
                             
                                <tr>
                                    <td class="tb-product">
                                        <div class="product-name"><a href="#">${i.productname }</a></div>
                                    </td>
                                    <td class="tb-product">
                                        <div class="product-name"><a href="#">${i.price }</a></div>
                                    </td>
                                    <td class="tb-product">
                                        <div class="product-name"><a href="#">${i.rprice }</a></div>
                                    </td>
                                    
                                    <td class="tb-price">
                                        <div class="product-name"><a href="#">${i.shopnum }</a></div>
                                    </td>
                                    <td class="tb-image"><a href="#" class="item-photo"><img
                                            src="${ctx}/upload/${i.picture }"
				...
				<button class="layui-btn layui-btn-xs" style="float: left;margin-left:5px;" onclick="window.location.href='checkOrderitem?pagenum=${orderitems.prepagenum}'">上一页</button>
				<form class="layui-form" style="float: left" action="checkOrderitem" method="get">
					<font style="margin-left:5px;">当前页数</font>
					<input style="margin-left:5px;width:50px;" type="text" name="nowpage" value="${orderitems.pagenum}"/>
					<font style="margin-left:5px;">总页数${orderitems.totalpagenum}</font>
					<input class="layui-btn layui-btn-xs" type="submit" value="跳转"/>
				</form>
				<button style="margin-left:5px;" class="layui-btn layui-btn-xs" onclick="window.location.href='checkOrderitem?pagenum=${orderitems.nextpagenum}'">下一页</button>
			</div>
