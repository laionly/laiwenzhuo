                ...
                <ul class="nav-top-right dagon-nav">
                    <li class="menu-item-has-children">
                        <a href="#" class="dropdown-toggle">
                            <img src="${ctx}/assets/images/general/l1.jpg" alt="flag">English<i class="fa fa-angle-down"
                                                                                         aria-hidden="true"></i>
                        </a>
                                        ...
                                        <div class="minicart-items-wrapper">
                                            <ol class="minicart-items">
                                                <li class="product-inner">
                                                    <div class="product-thumb style1">
                                                        <div class="thumb-inner">
                                                            <a href="#"><img src="${ctx}/assets/images/home1/c1.jpg"
                                                                             alt="c1"></a>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="product-inner">
                                                    <div class="product-thumb style1">
                                                        <div class="thumb-inner">
                                                            <a href="#"><img src="${ctx}/assets/images/home1/c2.jpg"
                                                                             alt="c2"></a>
                                                        </div>
                                                    </div>
                                                    <div class="product-innfo">
    ...
    <main class="site-main shopping-cart">
        <div class="container">
            <ol class="breadcrumb-page">
                ...
                <li class=""><a href="checkOrder?uid=${sessionScope.user.uid }">我的订单</a></li>
            </ol>
        </div>
        <div class="container">
            <div class="row">
		...
		<c:if test="${empty(orderlist.list)}">
			<p style="display: block; text-align: center;">您的订单为空</p>
		</c:if>
		<c:if test="${!empty(orderlist.list)}">
                            <table class="table">
                                <thead>
                                <tr>
                                    <th class="tb-image">订单编号</th>
                                    <th class="tb-product">收货人</th>
                                    <th class="tb-product">收货地址</th>
                                    <th class="tb-product">电话号码</th>
                                    <th class="tb-price">总价</th>
                                    <th class="tb-qty">下单时间</th>
                                    <th class="tb-add">退货</th>
                              ...
                              <c:forEach var="i" items="${orderlist.list}">
                                <tr>
                                    <td class="tb-product">
                                        <div class="product-name"><a href="checkOrderitem?orid=${i.orid }">${i.orid }</a></div>
                                    </td>
                                    <td class="tb-product">
                                        <div class="product-name"><a href="checkOrderitem?orid=${i.orid }">${i.name }</a></div>
                                    </td>
                                    <td class="tb-product">
                                        <div class="product-name"><a href="checkOrderitem?orid=${i.orid }">${i.address }</a></div>
                                    </td>
                                    <td class="tb-product">
                                        <div class="product-name"><a href="checkOrderitem?orid=${i.orid }">${i.phone }</a></div>
                                    </td>
                                    <td class="tb-price">
                                        <div class="product-name"><a href="checkOrderitem?orid=${i.orid }">${i.amount }</a></div>
                                    </td>
                                    <td class="tb-price">
                                        <div class="product-name"><a href="checkOrderitem?orid=${i.orid }">${i.orderdate }</a></div>
                                    </td>
                                    <td class="tb-add">
                                        <button type="">
                                            <span>退货申请</span>
				...
				<button class="layui-btn layui-btn-xs" style="float: left;margin-left:5px;" onclick="window.location.href='checkOrder?pagenum=${orderlist.prepagenum}'">上一页</button>
				<form class="layui-form" style="float: left" action="checkOrder" method="get">
					<font style="margin-left:5px;">当前页数</font>
					<input style="margin-left:5px;width:50px;" type="text" name="nowpage" value="${orderlist.pagenum}"/>
					<font style="margin-left:5px;">总页数${orderlist.totalpagenum}</font>
					<input class="layui-btn layui-btn-xs" type="submit" value="跳转"/>
				</form>
				<button style="margin-left:5px;" class="layui-btn layui-btn-xs" onclick="window.location.href='checkOrder?pagenum=${orderlist.nextpagenum}'">下一页</button>
			</div>
