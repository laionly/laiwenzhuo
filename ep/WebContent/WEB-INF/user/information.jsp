...
<div class="wrapper">
                                ...
                                <form>
                                    <div class="minicart-content-wrapper">
                                        ...
                                        <div class="actions">
                                            ...
                                            <a class="btn btn-checkout" href="checkout.jsp">查看订单</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <p class="form-row form-row-wide" style="margin-left:350px;margin-top: 90px" >
                                <label>用户名:<span class="required"></span></label>
                                <input type="text" value="${user.username }" name="username" placeholder="用户名" class="input-text">
     </p>
     <p class="form-row form-row-wide" style="margin-left:350px" >
                                <label>密码:<span class="required"></span></label>
                                <input type="text" value="${user.password }" name="password" placeholder="密码" class="input-text">
     </p>
     <p class="form-row form-row-wide" style="margin-left:350px" >
                                <label>地址:<span class="required"></span></label>
                                <input type="text" value="${user.address }" name="address" placeholder="地址" class="input-text">
     </p>
     <p class="form-row form-row-wide" style="margin-left:350px" >
                                <label>电话:<span class="required"></span></label>
                                <input type="text" value="${user.phone }" name="phone" placeholder="电话号码" class="input-text">
     </p>
     <p class="form-row form-row-wide" style="margin-left:350px" >
                                <label>邮箱:<span class="required"></span></label>
                                <input type="text" value="${user.email }" name="email" placeholder="邮箱" class="input-text">
     </p>
     <input type="submit" value="修改" name="Submit" style="margin-left:450px">
     </form>
    <!-- FOOTER -->
