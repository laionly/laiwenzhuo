                ...
                <div class="col-md-12">
                    <form class="form-cart form-wishlist">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td class="tb-image"><a href="#" class="item-photo"><img
                                            src="${ctx}/upload/${uf.product.picture }"
                                    ...
                                    <td class="tb-add">
                                    <a href="addProductinShop_Cart?pid=${uf.product.pid }&fid=${uf.fid }">
                                        <button type="button" >
                                            <span>添加进购物车</span>
                                        </button>
                                        </a>
                                    ...
                                    <td class="tb-remove">
                                        <a href="removeFocustable?fid=${uf.fid }" class="action-remove"><span><i class="flaticon-close"
                        ...
                        <div class="cart-actions">
                            ...
                            <a href="checkIFocustables">
                                <button type="button" class="btn-clean">
                                    <span>更新收藏夹</span>
                                </button>
                            </a>

                            <a href="removeAllFocustableByUid">
