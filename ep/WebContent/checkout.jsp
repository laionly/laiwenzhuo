...
<div class="wrapper">
                        ...
                        <div class="block-minicart dropdown">
                            <a class="minicart" href="#">
                                ...
                                <span class="counter-your-cart">
                                        ...
                                        <span class="counter-price">${allAmount}</span>
                                ...
                                <form>
                                    <div class="minicart-content-wrapper">
                                        ...
                                        <div class="subtotal">
                                            ...
                                            <span class="price">${allAmount}</span>
                                        </div>
                                        <div class="actions">
    ...
    <main class="site-main checkout">
        ...
        <div class="container">
            <form action="place_order" class="checkout" method="post" name="checkout">
                <h4 class="title-checkout">填写地址</h4>
                <div class="row">
                    <div class="form-group col-md-6">
                        <label class="title">姓名*</label>
                        <input type="text" class="form-control" name="name" id="forFName" placeholder="Your name">
                    </div>
                    <div class="form-group col-md-6">
                        <label class="title">详细地址*</label>
                        <input type="text" class="form-control" name="address" id="forLName" placeholder="Street at apartment number">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="phone" placeholder="11 digits format">
                    </div>
                    <div class="form-group shipping col-md-6">
                        <ul>
                            <li><label class="inline"><input type="checkbox"><span class="input"></span>Create an
                                account?</label></li>
                            <li><label class="inline"><input type="checkbox"><span class="input"></span>Ship to a
                                different address?</label></li>
                        </ul>
                        ...
                        <input title="control" type="text" class="form-control">
                    ...
                    <div class="form-group payment col-md-6">
                        ...
                        <ul>
                            <li><label class="inline"><input type="checkbox"><span class="input"></span>Direct Bank
                                Transder</label></li>
                            <li><label class="inline"><input type="checkbox"><span class="input"></span>Cash on Delivery</label>
                            </li>
                            <li><label class="inline"><input type="checkbox"><span class="input"></span>Paypal</label>
                            </li>
                        </ul>
                        <p class="credit">You can pay with your credit<br> card if you don't have a paypal account</p>
                        <span class="grand-total">总计<span>${allAmount}</span></span>
                        <button type="submit" class="btn-order">现在下单</button>
                    </div>
                </div>
            </form>
        </div>
